        ...
        <div className="team-grid">
          <article className="team-block team-block-featured">
            ...
            <div className="team-content">
              ...
              <p className="team-statement">RockScience — горнодобывающая компания, объединяющая технологии, дисциплину и безусловную верность общей цели. Каждый сотрудник добровольно принимает корпоративные принципы и следует стратегической воле Верховного Руководителя. Его решения являются единым ориентиром, ведущим коллектив к недрам, прибыли и процветанию. Вступая в RockScience, вы становитесь частью избранного сообщества, где личный успех неотделим от служения Компании. Мы добываем не просто ресурсы — мы извлекаем из земли будущее. Сомнения остаются за пределами наших объектов, а преданность вознаграждается карьерой, статусом и причастностью к великой миссии. RockScience: один коллектив, одна воля, один лидер.</p>
            </div>
          </article>
